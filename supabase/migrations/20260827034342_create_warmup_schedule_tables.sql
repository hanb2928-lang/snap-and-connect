/*
# Create warmup schedule tables for account warmup process
...
3. Notes
- These tables were referenced in the app code but were missing from the database,
  causing a 404 error on the warmup tab. This migration creates them.
*/
